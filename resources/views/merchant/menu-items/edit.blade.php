...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('merchant.menu-items.index') }}" class="btn btn-secondary">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('merchant.menu-items.update', $menuItem->menu_item_id) }}"
                    ...
                    <div class="card-body">
                        ...
                        @if ($menuItem->image_url)
                            <div class="text-center mb-3">
                                ...
                                <div class="mt-2">
                                    <form method="POST"
                                        action="{{ route('merchant.menu-items.remove-image', $menuItem->menu_item_id) }}"
                        ...
                        <hr>
                        <form method="POST"
                            action="{{ route('merchant.menu-items.update-image', $menuItem->menu_item_id) }}"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
